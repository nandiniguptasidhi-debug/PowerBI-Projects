...
|---|---------|-------------|-------|
| 01 | [E-Commerce Sales Dashboard](./01_Ecommerce-Sales-Dashboard) | Sales, profit & regional analysis for an e-commerce store | Power BI, Excel, SQL |
...
| 03 | [Finance Dashboard Assignment](./03_Finance-Dashboard-Assignment) | Finance KPI tracking dashboard | Power BI, DAX |
